...
var resourceTypes = map[string]ResourceType{
	...
	"AWS::Organizations::Organization": {
		...
		GetDescriber:         ParallelDescribeRegionalSingleResource(describer.GetOrganizationsOrganization),
	...
	"AWS::CloudSearch::Domain": {
		...
		GetDescriber:         ParallelDescribeRegionalSingleResource(describer.GetCloudSearchDomain),
	...
	"AWS::SecurityHub::Hub": {
		...
		GetDescriber:         ParallelDescribeRegionalSingleResource(describer.GetSecurityHubHub),
		TerraformName:        []string{},
		TerraformServiceName: "",
		FastDiscovery:        false,
		Summarize:            true,
	...
	"AWS::StorageGateway::StorageGateway": {
		...
		GetDescriber:         ParallelDescribeRegionalSingleResource(describer.GetStorageGatewayStorageGateway),
	...
	"AWS::ElasticLoadBalancingV2::ListenerRule": {
		...
		GetDescriber:         ParallelDescribeRegionalSingleResource(describer.GetElasticLoadBalancingV2ListenerRule),
	...
	"AWS::IAM::Role": {
		...
		GetDescriber:         ParallelDescribeRegionalSingleResource(describer.GetIAMRole),
	...
	"AWS::CodeCommit::Repository": {
		...
		GetDescriber:         ParallelDescribeRegionalSingleResource(describer.GetCodeCommitRepository),
	...
	"AWS::CloudFront::OriginAccessControl": {
		...
		GetDescriber:         ParallelDescribeRegionalSingleResource(describer.GetCloudFrontOriginAccessControl),
	...
	"AWS::ElastiCache::ParameterGroup": {
		...
		GetDescriber:         ParallelDescribeRegionalSingleResource(describer.GetElastiCacheParameterGroup),
	...
	"AWS::MemoryDb::Cluster": {
		...
		GetDescriber:         ParallelDescribeRegionalSingleResource(describer.GetMemoryDbCluster),
	...
	"AWS::DirectConnect::Gateway": {
		...
		GetDescriber:         ParallelDescribeRegionalSingleResource(describer.GetDirectConnectGateway),
	...
	"AWS::GuardDuty::PublishingDestination": {
		...
		GetDescriber:         ParallelDescribeRegionalSingleResource(describer.GetGuardDutyPublishingDestination),
	...
	"AWS::KinesisAnalyticsV2::Application": {
		...
		GetDescriber:         ParallelDescribeRegionalSingleResource(describer.GetKinesisAnalyticsV2Application),
	...
	"AWS::EFS::FileSystem": {
		...
		GetDescriber:         ParallelDescribeRegionalSingleResource(describer.GetEFSFileSystem),
	...
	"AWS::Kafka::Cluster": {
		...
		GetDescriber:         ParallelDescribeRegionalSingleResource(describer.GetKafkaCluster),
	...
	"AWS::SecretsManager::Secret": {
		...
		GetDescriber:         ParallelDescribeRegionalSingleResource(describer.GetSecretsManagerSecret),
	...
	"AWS::CloudFront::Function": {
		...
		GetDescriber:         ParallelDescribeRegionalSingleResource(describer.GetCloudFrontFunction),
	...
	"AWS::GlobalAccelerator::EndpointGroup": {
		...
		GetDescriber:         ParallelDescribeRegionalSingleResource(describer.GetGlobalAcceleratorEndpointGroup),
	...
	"AWS::DAX::ParameterGroup": {
		...
		GetDescriber:         ParallelDescribeRegionalSingleResource(describer.GetDAXParameterGroup),
	...
	"AWS::SQS::Queue": {
		...
		GetDescriber:         ParallelDescribeRegionalSingleResource(describer.GetSQSQueue),
	...
	"AWS::GuardDuty::Member": {
		...
		GetDescriber:         ParallelDescribeRegionalSingleResource(describer.GetGuardDutyMember),
	...
	"AWS::EFS::AccessPoint": {
		...
		GetDescriber:         ParallelDescribeRegionalSingleResource(describer.GetEFSAccessPoint),
	...
	"AWS::IAM::PolicyAttachment": {
		...
		GetDescriber:         ParallelDescribeRegionalSingleResource(describer.GetIAMPolicyAttachment),
	...
	"AWS::RDS::GlobalCluster": {
		...
		GetDescriber:         ParallelDescribeRegionalSingleResource(describer.GetRDSGlobalCluster),
	...
	"AWS::GuardDuty::Detector": {
		...
		GetDescriber:         ParallelDescribeRegionalSingleResource(describer.GetGuardDutyDetector),
	...
	"AWS::SNS::Topic": {
		...
		GetDescriber:         ParallelDescribeRegionalSingleResource(describer.GetSNSTopic),
	...
	"AWS::AppConfig::Application": {
		...
		GetDescriber:         ParallelDescribeRegionalSingleResource(describer.GetAppConfigApplication),
	...
	"AWS::Batch::Job": {
		...
		GetDescriber:         ParallelDescribeRegionalSingleResource(describer.GetBatchJob),
	...
	"AWS::IAM::VirtualMFADevice": {
		...
		GetDescriber:         ParallelDescribeRegionalSingleResource(describer.GetIAMVirtualMFADevice),
	...
	"AWS::WAFv2::WebACL": {
		...
		GetDescriber:         ParallelDescribeRegionalSingleResource(describer.GetWAFv2WebACL),
	...
	"AWS::ApplicationAutoScaling::Target": {
		...
		GetDescriber:         ParallelDescribeRegionalSingleResource(describer.GetApplicationAutoScalingTarget),
	...
	"AWS::Backup::Vault": {
		...
		GetDescriber:         ParallelDescribeRegionalSingleResource(describer.GetBackupVault),
	...
	"AWS::ApiGateway::ApiKey": {
		...
		GetDescriber:         ParallelDescribeRegionalSingleResource(describer.GetApiGatewayApiKey),
	...
	"AWS::Glue::Connection": {
		...
		GetDescriber:         ParallelDescribeRegionalSingleResource(describer.GetGlueConnection),
	...
	"AWS::RDS::DBSnapshot": {
		...
		GetDescriber:         ParallelDescribeRegionalSingleResource(describer.GetRDSDBSnapshot),
	...
	"AWS::EMR::Cluster": {
		...
		GetDescriber:         ParallelDescribeRegionalSingleResource(describer.GetEMRCluster),
	...
	"AWS::IAM::AccessKey": {
		...
		GetDescriber:         ParallelDescribeRegionalSingleResource(describer.GetIAMAccessKey),
	...
	"AWS::Glue::CatalogTable": {
		...
		GetDescriber:         ParallelDescribeRegionalSingleResource(describer.GetGlueCatalogTable),
	...
	"AWS::RedshiftServerless::Snapshot": {
		...
		GetDescriber:         ParallelDescribeRegionalSingleResource(describer.GetRedshiftServerlessSnapshot),
	...
	"AWS::Workspaces::Bundle": {
		...
		GetDescriber:         ParallelDescribeRegionalSingleResource(describer.GetWorkspacesBundle),
	...
	"AWS::CloudTrail::Trail": {
		...
		GetDescriber:         ParallelDescribeRegionalSingleResource(describer.GetCloudTrailTrail),
	...
	"AWS::ECR::Image": {
		...
		GetDescriber:         ParallelDescribeRegionalSingleResource(describer.GetECRImage),
	...
	"AWS::IAM::ServerCertificate": {
		...
		GetDescriber:         ParallelDescribeRegionalSingleResource(describer.GetIAMServerCertificate),
	...
	"AWS::Keyspaces::Keyspace": {
		...
		GetDescriber:         ParallelDescribeRegionalSingleResource(describer.GetKeyspacesKeyspace),
	...
	"AWS::SageMaker::EndpointConfiguration": {
		...
		GetDescriber:         ParallelDescribeRegionalSingleResource(describer.GetMakerEndpointConfigurationHandle),
	...
	"AWS::EMR::InstanceFleet": {
		...
		GetDescriber:         ParallelDescribeRegionalSingleResource(describer.GetEMRInstanceFleet),
	...
	"AWS::EKS::FargateProfile": {
		...
		GetDescriber:         ParallelDescribeRegionalSingleResource(describer.GetEKSFargateProfile),
	...
	"AWS::IAM::AccountPasswordPolicy": {
		...
		GetDescriber:         ParallelDescribeRegionalSingleResource(describer.GetIAMAccountPasswordPolicy),
	...
	"AWS::CodePipeline::Pipeline": {
		...
		GetDescriber:         ParallelDescribeRegionalSingleResource(describer.GetCodePipelinePipeline),
	...
	"AWS::DAX::Cluster": {
		...
		GetDescriber:         ParallelDescribeRegionalSingleResource(describer.GetDAXCluster),
	...
	"AWS::DLM::LifecyclePolicy": {
		...
		GetDescriber:         ParallelDescribeRegionalSingleResource(describer.GetDLMLifecyclePolicy),
	...
	"AWS::OpsWorksCM::Server": {
		...
		GetDescriber:         ParallelDescribeRegionalSingleResource(describer.GetOpsWorksCMServer),
		TerraformName:        []string{},
		TerraformServiceName: "",
		FastDiscovery:        false,
		Summarize:            true,
	...
	"AWS::ElastiCache::SubnetGroup": {
		...
		GetDescriber:         ParallelDescribeRegionalSingleResource(describer.GetElastiCacheSubnetGroup),
	...
	"AWS::FSX::Volume": {
		...
		GetDescriber:         ParallelDescribeRegionalSingleResource(describer.GetFSXVolume),
	...
	"AWS::Amplify::App": {
		...
		GetDescriber:         ParallelDescribeRegionalSingleResource(describer.GetAmplifyApp),
	...
	"AWS::FSX::StorageVirtualMachine": {
		...
		GetDescriber:         ParallelDescribeRegionalSingleResource(describer.GetFSXStorageVirtualMachine),
	...
	"AWS::ApiGateway::Authorizer": {
		...
		GetDescriber:         ParallelDescribeRegionalSingleResource(describer.GetApiGatewayAuthorizer),
	...
	"AWS::AppStream::Stack": {
		...
		GetDescriber:         ParallelDescribeRegionalSingleResource(describer.GetAppStreamStack),
	...
	"AWS::RDS::DBClusterSnapshot": {
		...
		GetDescriber:         ParallelDescribeRegionalSingleResource(describer.GetRDSDBClusterSnapshot),
	...
	"AWS::Backup::Framework": {
		...
		GetDescriber:         ParallelDescribeRegionalSingleResource(describer.GetBackupFramework),
	...
	"AWS::CodeBuild::SourceCredential": {
		...
		GetDescriber:         ParallelDescribeRegionalSingleResource(describer.GetCodeBuildSourceCredential),
	...
	"AWS::IAM::ServiceSpecificCredential": {
		...
		GetDescriber:         ParallelDescribeRegionalSingleResource(describer.GetIAMServiceSpecificCredential),
	...
	"AWS::NetworkFirewall::Firewall": {
		...
		GetDescriber:         ParallelDescribeRegionalSingleResource(describer.GetNetworkFirewallFirewall),
	...
	"AWS::Workspaces::Workspace": {
		...
		GetDescriber:         ParallelDescribeRegionalSingleResource(describer.GetWorkspacesWorkspace),
	...
	"AWS::ElasticSearch::Domain": {
		...
		GetDescriber:         ParallelDescribeRegionalSingleResource(describer.GetESDomain),
	...
	"AWS::EFS::MountTarget": {
		...
		GetDescriber:         ParallelDescribeRegionalSingleResource(describer.GetEFSMountTarget),
	...
	"AWS::GlobalAccelerator::Listener": {
		...
		GetDescriber:         ParallelDescribeRegionalSingleResource(describer.GetGlobalAcceleratorListener),
	...
	"AWS::EKS::Addon": {
		...
		GetDescriber:         ParallelDescribeRegionalSingleResource(describer.GetEKSAddon),
	...
	"AWS::IAM::Policy": {
		...
		GetDescriber:         ParallelDescribeRegionalSingleResource(describer.GetIAMPolicy),
	...
	"AWS::Redshift::Cluster": {
		...
		GetDescriber:         ParallelDescribeRegionalSingleResource(describer.GetRedshiftCluster),
	...
	"AWS::WAFRegional::Rule": {
		...
		GetDescriber:         ParallelDescribeRegionalSingleResource(describer.GetWAFRegionalRule),
	...
	"AWS::Glue::DataDataCatalogEncryptionSettings": {
		Connector:            source.CloudAWS,
		...
		GetDescriber:         ParallelDescribeRegionalSingleResource(describer.GetGlueDataCatalogEncryptionSettings),
	...
	"AWS::IAM::SamlProvider": {
		...
		GetDescriber:         ParallelDescribeRegionalSingleResource(describer.GetIAMSamlProvider),
	...
	"AWS::Route53::HostedZone": {
		...
		GetDescriber:         ParallelDescribeRegionalSingleResource(describer.GetRoute53HostedZone),
	...
	"AWS::FSX::Snapshot": {
		...
		GetDescriber:         ParallelDescribeRegionalSingleResource(describer.GetFSXSnapshot),
	...
	"AWS::ElasticBeanstalk::Environment": {
		...
		GetDescriber:         ParallelDescribeRegionalSingleResource(describer.GetElasticBeanstalkEnvironment),
	...
	"AWS::Glue::DevEndpoint": {
		...
		GetDescriber:         ParallelDescribeRegionalSingleResource(describer.GetGlueDevEndpoint),
	...
	"AWS::CloudFront::Distribution": {
		...
		GetDescriber:         ParallelDescribeRegionalSingleResource(describer.GetCloudFrontDistribution),
	...
	"AWS::AppStream::Fleet": {
		...
		GetDescriber:         ParallelDescribeRegionalSingleResource(describer.GetAppStreamFleet),
	...
	"AWS::SES::ConfigurationSet": {
		...
		GetDescriber:         ParallelDescribeRegionalSingleResource(describer.GetSESConfigurationSet),
	...
	"AWS::IAM::User": {
		...
		GetDescriber:         ParallelDescribeRegionalSingleResource(describer.GetIAMUser),
	...
	"AWS::CloudFront::OriginRequestPolicy": {
		...
		GetDescriber:         ParallelDescribeRegionalSingleResource(describer.GetCloudFrontOriginRequestPolicy),
	...
	"AWS::GuardDuty::IPSet": {
		...
		GetDescriber:         ParallelDescribeRegionalSingleResource(describer.GetGuardDutyIPSet),
	...
	"AWS::EKS::Cluster": {
		...
		GetDescriber:         ParallelDescribeRegionalSingleResource(describer.GetEKSCluster),
	...
	"AWS::Grafana::Workspace": {
		...
		GetDescriber:         ParallelDescribeRegionalSingleResource(describer.GetGrafanaWorkspace),
	...
	"AWS::Glue::CatalogDatabase": {
		...
		GetDescriber:         ParallelDescribeRegionalSingleResource(describer.GetGlueCatalogDatabase),
	...
	"AWS::CloudFormation::StackSet": {
		...
		GetDescriber:         ParallelDescribeRegionalSingleResource(describer.GetCloudFormationStackSet),
	...
	"AWS::ApiGateway::UsagePlan": {
		...
		GetDescriber:         ParallelDescribeRegionalSingleResource(describer.GetApiGatewayUsagePlan),
	...
	"AWS::ElasticBeanstalk::Application": {
		...
		GetDescriber:         ParallelDescribeRegionalSingleResource(describer.GetElasticBeanstalkApplication),
	...
	"AWS::OpenSearch::Domain": {
		...
		GetDescriber:         ParallelDescribeRegionalSingleResource(describer.GetOpenSearchDomain),
	...
	"AWS::RDS::DBEventSubscription": {
		...
		GetDescriber:         ParallelDescribeRegionalSingleResource(describer.GetRDSDBEventSubscription),
	...
	"AWS::EC2::SecurityGroupRule": {
		...
		GetDescriber:         ParallelDescribeRegionalSingleResource(describer.GetEC2SecurityGroupRule),
	...
	"AWS::SES::Identity": {
		...
		GetDescriber:         ParallelDescribeRegionalSingleResource(describer.GetSESIdentity),
	...
	"AWS::WAF::Rule": {
		...
		GetDescriber:         ParallelDescribeRegionalSingleResource(describer.GetWAFRule),
	...
	"AWS::CloudTrail::EventDataStore": {
		...
		GetDescriber:         ParallelDescribeRegionalSingleResource(describer.GetCloudTrailEventDataStore),
	...
	"AWS::ImageBuilder::Image": {
		...
		GetDescriber:         ParallelDescribeRegionalSingleResource(describer.GetImageBuilderImage),
	...
	"AWS::Redshift::ClusterParameterGroup": {
		...
		GetDescriber:         ParallelDescribeRegionalSingleResource(describer.GetRedshiftClusterParameterGroup),
	...
	"AWS::Account::AlternateContact": {
		...
		GetDescriber:         ParallelDescribeRegionalSingleResource(describer.GetAccountAlternateContact),
	...
	"AWS::Inspector::AssessmentTarget": {
		...
		GetDescriber:         ParallelDescribeRegionalSingleResource(describer.GetInspectorAssessmentTarget),
	...
	"AWS::CloudFront::ResponseHeadersPolicy": {
		...
		GetDescriber:         ParallelDescribeRegionalSingleResource(describer.GetCloudFrontResponseHeadersPolicy),
	...
	"AWS::ECR::Repository": {
		...
		GetDescriber:         ParallelDescribeRegionalSingleResource(describer.GetECRRepository),
	...
	"AWS::IAM::Group": {
		...
		GetDescriber:         ParallelDescribeRegionalSingleResource(describer.GetIAMGroup),
	...
	"AWS::ECS::TaskSet": {
		...
		GetDescriber:         ParallelDescribeRegionalSingleResource(describer.GetECSTaskSet),
	...
	"AWS::Kinesis::Stream": {
		...
		GetDescriber:         ParallelDescribeRegionalSingleResource(describer.GetKinesisStream),
	...
	"AWS::Kinesis::Consumer": {
		...
		GetDescriber:         ParallelDescribeRegionalSingleResource(describer.GetKinesisConsumer),
	...
	"AWS::ElastiCache::ReplicationGroup": {
		...
		GetDescriber:         ParallelDescribeRegionalSingleResource(describer.GetElastiCacheReplicationGroup),
	...
	"AWS::GlobalAccelerator::Accelerator": {
		...
		GetDescriber:         ParallelDescribeRegionalSingleResource(describer.GetGlobalAcceleratorAccelerator),
	...
	"AWS::EMR::InstanceGroup": {
		...
		GetDescriber:         ParallelDescribeRegionalSingleResource(describer.GetEMRInstanceGroup),
	...
	"AWS::MWAA::Environment": {
		...
		GetDescriber:         ParallelDescribeRegionalSingleResource(describer.GetMWAAEnvironment),
	...
	"AWS::CodeArtifact::Domain": {
		...
		GetDescriber:         ParallelDescribeRegionalSingleResource(describer.GetCodeArtifactDomain),
	...
	"AWS::RDS::OptionGroup": {
		...
		GetDescriber:         ParallelDescribeRegionalSingleResource(describer.GetRDSOptionGroup),
		TerraformName:        []string{},
		TerraformServiceName: "",
		FastDiscovery:        false,
		Summarize:            true,
	...
	"AWS::GuardDuty::Filter": {
		...
		GetDescriber:         ParallelDescribeRegionalSingleResource(describer.GetGuardDutyFilter),
	...
	"AWS::GuardDuty::ThreatIntelSet": {
		...
		GetDescriber:         ParallelDescribeRegionalSingleResource(describer.GetGuardDutyThreatIntelSet),
	...
	"AWS::MQ::Broker": {
		...
		GetDescriber:         ParallelDescribeRegionalSingleResource(describer.GetMQBroker),
	...
	"AWS::ACMPCA::CertificateAuthority": {
		...
		GetDescriber:         ParallelDescribeRegionalSingleResource(describer.GetACMPCACertificateAuthority),
	...
	"AWS::DirectConnect::Connection": {
		...
		GetDescriber:         ParallelDescribeRegionalSingleResource(describer.GetDirectConnectConnection),
	...
	"AWS::FSX::FileSystem": {
		...
		GetDescriber:         ParallelDescribeRegionalSingleResource(describer.GetFSXFileSystem),
	...
	"AWS::Glue::SecurityConfiguration": {
		...
		GetDescriber:         ParallelDescribeRegionalSingleResource(describer.GetGlueSecurityConfiguration),
	...
	"AWS::ECR::PublicRepository": {
		...
		GetDescriber:         ParallelDescribeRegionalSingleResource(describer.GetECRPublicRepository),
	...
	"AWS::ElasticLoadBalancingV2::TargetGroup": {
		...
		GetDescriber:         ParallelDescribeRegionalSingleResource(describer.GetElasticLoadBalancingV2TargetGroup),
	...
	"AWS::CloudFront::CachePolicy": {
		...
		GetDescriber:         ParallelDescribeRegionalSingleResource(describer.GetCloudFrontCachePolicy),
	...
	"AWS::CodeArtifact::Repository": {
		...
		GetDescriber:         ParallelDescribeRegionalSingleResource(describer.GetCodeArtifactRepository),
	...
	"AWS::AMP::Workspace": {
		...
		GetDescriber:         ParallelDescribeRegionalSingleResource(describer.GetAMPWorkspace),
	...
	"AWS::SageMaker::NotebookInstance": {
		...
		GetDescriber:         ParallelDescribeRegionalSingleResource(describer.GetSageMakerNotebookInstance),
	...
	"AWS::Keyspaces::Table": {
		...
		GetDescriber:         ParallelDescribeRegionalSingleResource(describer.GetKeyspacesTable),
	...
	"AWS::DAX::SubnetGroup": {
		...
		GetDescriber:         ParallelDescribeRegionalSingleResource(describer.GetDAXSubnetGroup),
	...
	"AWS::DynamoDb::GlobalTable": {
		...
		GetDescriber:         ParallelDescribeRegionalSingleResource(describer.GetDynamoDbGlobalTable),
	...
	"AWS::ElasticLoadBalancing::LoadBalancer": {
		...
		GetDescriber:         ParallelDescribeRegionalSingleResource(describer.GetElasticLoadBalancingLoadBalancer),
	...
	"AWS::RedshiftServerless::Namespace": {
		...
		GetDescriber:         ParallelDescribeRegionalSingleResource(describer.GetRedshiftServerlessNamespace),
	...
	"AWS::CloudFront::OriginAccessIdentity": {
		...
		GetDescriber:         ParallelDescribeRegionalSingleResource(describer.GetCloudFrontOriginAccessIdentity),
	...
	"AWS::EKS::Nodegroup": {
		...
		GetDescriber:         ParallelDescribeRegionalSingleResource(describer.GetEKSNodegroup),
	...
	"AWS::DMS::ReplicationInstance": {
		...
		GetDescriber:         ParallelDescribeRegionalSingleResource(describer.GetDMSReplicationInstance),
	...
	"AWS::DynamoDb::Table": {
		...
		GetDescriber:         ParallelDescribeRegionalSingleResource(describer.GetDynamoDbTable),
	...
	"AWS::Shield::ProtectionGroup": {
		...
		GetDescriber:         ParallelDescribeRegionalSingleResource(describer.GetShieldProtectionGroup),
	...
	"AWS::Firehose::DeliveryStream": {
		...
		GetDescriber:         ParallelDescribeRegionalSingleResource(describer.GetFirehoseDeliveryStream),
	...
	"AWS::KMS::Alias": {
		...
		GetDescriber:         ParallelDescribeRegionalSingleResource(describer.GetKMSAlias),
	...
	"AWS::Lambda::Alias": {
		...
		GetDescriber:         ParallelDescribeRegionalSingleResource(describer.GetLambdaAlias),
	...
	"AWS::Lambda::LayerVersion": {
		...
		GetDescriber:         ParallelDescribeRegionalSingleResource(describer.GetLambdaLayerVersion),
	...
	"AWS::Lightsail::Instance": {
		...
		GetDescriber:         ParallelDescribeRegionalSingleResource(describer.GetLightsailInstance),
	...
	"AWS::Macie2::ClassificationJob": {
		...
		GetDescriber:         ParallelDescribeRegionalSingleResource(describer.GetMacie2ClassificationJob),
	...
	"AWS::MediaStore::Container": {
		...
		GetDescriber:         ParallelDescribeRegionalSingleResource(describer.GetMediaStoreContainer),
	...
	"AWS::Route53Resolver::ResolverEndpoint": {
		...
		GetDescriber:         ParallelDescribeRegionalSingleResource(describer.GetRoute53ResolverResolverEndpoint),
	...
	"AWS::Route53Domains::Domain": {
		...
		GetDescriber:         ParallelDescribeRegionalSingleResource(describer.GetRoute53Domain),
	...
	"AWS::Route53::Record": {
		...
		GetDescriber:         ParallelDescribeRegionalSingleResource(describer.GetRoute53Record),
	...
	"AWS::Route53::TrafficPolicy": {
		...
		GetDescriber:         ParallelDescribeRegionalSingleResource(describer.GetRoute53TrafficPolicy),
	...
	"AWS::Route53::TrafficPolicyInstance": {
		...
		GetDescriber:         ParallelDescribeRegionalSingleResource(describer.GetRoute53TrafficPolicyInstance),
	...
	"AWS::SageMaker::Model": {
		...
		GetDescriber:         ParallelDescribeRegionalSingleResource(describer.GetSageMakerModel),
	...
	"AWS::SecurityHub::ActionTarget": {
		...
		GetDescriber:         ParallelDescribeRegionalSingleResource(describer.GetSecurityHubActionTarget),
	...
	"AWS::SecurityHub::FindingAggregator": {
		...
		GetDescriber:         ParallelDescribeRegionalSingleResource(describer.GetSecurityHubFindingAggregator),
	...
	"AWS::SecurityHub::Insight": {
		...
		GetDescriber:         ParallelDescribeRegionalSingleResource(describer.GetSecurityHubInsight),
	...
	"AWS::SecurityHub::Member": {
		...
		GetDescriber:         ParallelDescribeRegionalSingleResource(describer.GetSecurityHubMember),
	...
	"AWS::SecurityHub::StandardsControl": {
		...
		GetDescriber:         ParallelDescribeRegionalSingleResource(describer.GetSecurityHubStandardsControl),
	...
	"AWS::SecurityHub::StandardsSubscription": {
		...
		GetDescriber:         ParallelDescribeRegionalSingleResource(describer.GetSecurityHubStandardsSubscription),
	...
	"AWS::Ram::PrincipalAssociation": {
		...
		GetDescriber:         ParallelDescribeRegionalSingleResource(describer.GetRamPrincipalAssociation),
	...
	"AWS::Ram::ResourceAssociation": {
		...
		GetDescriber:         ParallelDescribeRegionalSingleResource(describer.GetRamResourceAssociation),
	...
	"AWS::RDS::ReservedDBInstance": {
		...
		GetDescriber:         ParallelDescribeRegionalSingleResource(describer.GetRDSReservedDBInstance),
	...
	"AWS::Redshift::SubnetGroup": {
		...
		GetDescriber:         ParallelDescribeRegionalSingleResource(describer.GetRedshiftSubnetGroup),
	...
	"AWS::SeverlessApplicationRepository::Application": {
		...
		GetDescriber:         ParallelDescribeRegionalSingleResource(describer.GetServerlessApplicationRepositoryApplication),
