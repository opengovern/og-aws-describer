...
var resourceTypes = map[string]ResourceType{
	...
	"AWS::IAM::AccountSummary": {
		...
		ResourceLabel:        "",
		ServiceName:          "IAM",
		ListDescriber:        ParallelDescribeRegional(describer.IAMAccountSummary),
		GetDescriber:         nil,
		TerraformName:        "",
		TerraformServiceName: "",
	},
	...
	"AWS::IAM::Role": {
		...
		ServiceName:          "IAM",
		ListDescriber:        ParallelDescribeRegional(describer.IAMRole),
		GetDescriber:         nil,
	...
	"AWS::CloudFront::Function": {
		...
		ResourceLabel:        "",
		ServiceName:          "CloudFront",
		ListDescriber:        ParallelDescribeRegional(describer.CloudFrontFunction),
		GetDescriber:         nil,
	...
	"AWS::IAM::PolicyAttachment": {
		...
		ResourceLabel:        "",
		ServiceName:          "IAM",
		ListDescriber:        ParallelDescribeRegional(describer.IAMPolicyAttachment),
		GetDescriber:         nil,
	...
	"AWS::IAM::CredentialReport": {
		...
		ResourceLabel:        "",
		ServiceName:          "IAM",
		ListDescriber:        ParallelDescribeRegional(describer.IAMCredentialReport),
		GetDescriber:         nil,
		TerraformName:        "",
		TerraformServiceName: "",
	},
	...
	"AWS::IAM::VirtualMFADevice": {
		...
		ServiceName:          "IAM",
		ListDescriber:        ParallelDescribeRegional(describer.IAMVirtualMFADevice),
		GetDescriber:         nil,
	...
	"AWS::IAM::AccessKey": {
		...
		ResourceLabel:        "",
		ServiceName:          "IAM",
		ListDescriber:        ParallelDescribeRegional(describer.IAMAccessKey),
		GetDescriber:         nil,
	...
	"AWS::IAM::ServerCertificate": {
		...
		ResourceLabel:        "",
		ServiceName:          "IAM",
		ListDescriber:        ParallelDescribeRegional(describer.IAMServerCertificate),
		GetDescriber:         nil,
	...
	"AWS::IAM::Account": {
		...
		ResourceLabel:        "",
		ServiceName:          "IAM",
		ListDescriber:        ParallelDescribeRegional(describer.IAMAccount),
		GetDescriber:         nil,
		TerraformName:        "",
		TerraformServiceName: "",
	},
	...
	"AWS::IAM::AccountPasswordPolicy": {
		...
		ResourceLabel:        "",
		ServiceName:          "IAM",
		ListDescriber:        ParallelDescribeRegional(describer.IAMAccountPasswordPolicy),
		GetDescriber:         nil,
	...
	"AWS::IAM::ServiceSpecificCredential": {
		...
		ResourceLabel:        "",
		ServiceName:          "IAM",
		ListDescriber:        ParallelDescribeRegional(describer.IAMServiceSpecificCredential),
		GetDescriber:         nil,
	...
	"AWS::IAM::Policy": {
		...
		ServiceName:          "IAM",
		ListDescriber:        ParallelDescribeRegional(describer.IAMPolicy),
		GetDescriber:         nil,
	...
	"AWS::IAM::SamlProvider": {
		...
		ServiceName:          "IAM",
		ListDescriber:        ParallelDescribeRegional(describer.IAMSamlProvider),
		GetDescriber:         nil,
	...
	"AWS::Route53::HostedZone": {
		...
		ServiceName:          "Route53",
		ListDescriber:        ParallelDescribeRegional(describer.Route53HostedZone),
		GetDescriber:         nil,
	...
	"AWS::CloudFront::Distribution": {
		...
		ServiceName:          "CloudFront",
		ListDescriber:        ParallelDescribeRegional(describer.CloudFrontDistribution),
		GetDescriber:         nil,
	...
	"AWS::IAM::User": {
		...
		ServiceName:          "iam",
		ListDescriber:        ParallelDescribeRegional(describer.IAMUser),
		GetDescriber:         nil,
	...
	"AWS::CloudFront::OriginRequestPolicy": {
		...
		ResourceLabel:        "",
		ServiceName:          "CloudFront",
		ListDescriber:        ParallelDescribeRegional(describer.CloudFrontOriginRequestPolicy),
		GetDescriber:         nil,
	...
	"AWS::CloudFront::ResponseHeadersPolicy": {
		...
		ResourceLabel:        "",
		ServiceName:          "CloudFront",
		ListDescriber:        ParallelDescribeRegional(describer.CloudFrontResponseHeadersPolicy),
		GetDescriber:         nil,
	...
	"AWS::IAM::Group": {
		...
		ServiceName:          "IAM",
		ListDescriber:        ParallelDescribeRegional(describer.IAMGroup),
		GetDescriber:         nil,
	...
	"AWS::CloudFront::CachePolicy": {
		...
		ResourceLabel:        "",
		ServiceName:          "CloudFront",
		ListDescriber:        ParallelDescribeRegional(describer.CloudFrontCachePolicy),
		GetDescriber:         nil,
	...
	"AWS::CloudFront::OriginAccessIdentity": {
		...
		ResourceLabel:        "",
		ServiceName:          "CloudFront",
		ListDescriber:        ParallelDescribeRegional(describer.CloudFrontOriginAccessIdentity),
		GetDescriber:         nil,
