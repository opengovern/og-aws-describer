...
var resourceTypes = map[string]ResourceType{
	...
	"AWS::CostExplorer::ByUsageTypeMonthly": {
		...
		ListDescriber:        ParallelDescribeRegional(describer.CostByServiceUsageLastMonth),
		GetDescriber:         nil,
		TerraformName:        "",
		TerraformServiceName: "",
	},
	...
	"AWS::CostExplorer::ForcastDaily": {
		...
		ResourceLabel:        "",
		ServiceName:          "CostExplorer",
		ListDescriber:        ParallelDescribeRegional(describer.CostForecastDaily),
		GetDescriber:         nil,
		TerraformName:        "",
		TerraformServiceName: "",
	},
	...
	"AWS::CostExplorer::ByAccountMonthly": {
		...
		ResourceLabel:        "",
		ServiceName:          "CostExplorer",
		ListDescriber:        ParallelDescribeRegional(describer.CostByAccountLastMonth),
		GetDescriber:         nil,
		TerraformName:        "",
		TerraformServiceName: "",
	},
	...
	"AWS::CostExplorer::ByRecordTypeMonthly": {
		...
		ResourceLabel:        "",
		ServiceName:          "CostExplorer",
		ListDescriber:        ParallelDescribeRegional(describer.CostByRecordTypeLastMonth),
		GetDescriber:         nil,
		TerraformName:        "",
		TerraformServiceName: "",
	},
	...
	"AWS::CostExplorer::ByUsageTypeDaily": {
		...
		ResourceLabel:        "",
		ServiceName:          "CostExplorer",
		ListDescriber:        ParallelDescribeRegional(describer.CostByServiceUsageLastDay),
		GetDescriber:         nil,
		TerraformName:        "",
		TerraformServiceName: "",
	},
	...
	"AWS::CostExplorer::ByServiceMonthly": {
		...
		ResourceLabel:        "",
		ServiceName:          "CostExplorer",
		ListDescriber:        ParallelDescribeRegional(describer.CostByServiceLastMonth),
		GetDescriber:         nil,
		TerraformName:        "",
		TerraformServiceName: "",
	},
	...
	"AWS::CostExplorer::ByRecordTypeDaily": {
		...
		ResourceLabel:        "",
		ServiceName:          "CostExplorer",
		ListDescriber:        ParallelDescribeRegional(describer.CostByRecordTypeLastDay),
		GetDescriber:         nil,
		TerraformName:        "",
		TerraformServiceName: "",
	},
	...
	"AWS::CostExplorer::ByAccountDaily": {
		...
		ResourceLabel:        "",
		ServiceName:          "CostExplorer",
		ListDescriber:        ParallelDescribeRegional(describer.CostByAccountLastDay),
		GetDescriber:         nil,
		TerraformName:        "",
		TerraformServiceName: "",
	},
	...
	"AWS::CostExplorer::ForcastMonthly": {
		...
		ResourceLabel:        "",
		ServiceName:          "CostExplorer",
		ListDescriber:        ParallelDescribeRegional(describer.CostForecastMonthly),
		GetDescriber:         nil,
		TerraformName:        "",
		TerraformServiceName: "",
	},
	...
	"AWS::CostExplorer::ByServiceDaily": {
		...
		ResourceLabel:        "",
		ServiceName:          "CostExplorer",
		ListDescriber:        ParallelDescribeRegional(describer.CostByServiceLastDay),
		GetDescriber:         nil,
		TerraformName:        "",
		TerraformServiceName: "",
	},
	...
	"AWS::Lightsail::Instance": {
		...
		GetDescriber:         nil,
		TerraformName:        "aws_lightsail_instance",
	...
	"AWS::Macie2::ClassificationJob": {
		...
		GetDescriber:         nil,
		TerraformName:        "aws_macie2_classification_job",
	...
	"AWS::MediaStore::Container": {
		...
		GetDescriber:         nil,
		TerraformName:        "aws_media_store_container",
