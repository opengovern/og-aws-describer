...
var resourceTypes = map[string]ResourceType{
	...
	//	Connector:            source.CloudAWS,
	//	ResourceName:         "AWS::Tagging::Resources",
	//	ResourceLabel:        "",
	//	ServiceName:          "Tagging",
	//	ListDescriber:        ParallelDescribeRegional(describer.TaggingResources),
	//	GetDescriber:         nil,
	//	TerraformName:        "",
	//	TerraformServiceName: "",
	//},
	...
	"AWS::Route53Resolver::ResolverEndpoint": {
		...
		GetDescriber:         nil,
		TerraformName:        "aws_route53_resolver_endpoint",
	...
	"AWS::Route53Domains::Domain": {
		...
		GetDescriber:         nil,
		TerraformName:        "aws_route53domains_registered_domain",
	...
	"AWS::Route53::Record": {
		...
		GetDescriber:         nil,
		TerraformName:        "aws_route53_record",
		TerraformServiceName: "route53",
	},
	...
	"AWS::SecurityHub::ActionTarget": {
		...
		GetDescriber:         nil,
		TerraformName:        "aws_securityhub_action_target",
	...
	"AWS::SecurityHub::FindingAggregator": {
		...
		GetDescriber:         nil,
		TerraformName:        "aws_securityhub_finding_aggregator",
		TerraformServiceName: "securityhub",
	},
	"AWS::SecurityHub::Insight": {
		...
		GetDescriber:         nil,
		TerraformName:        "aws_securityhub_insight",
		TerraformServiceName: "securityhub",
	},
	"AWS::SecurityHub::Member": {
		...
		GetDescriber:         nil,
		TerraformName:        "aws_securityhub_member",
		TerraformServiceName: "securityhub",
	},
	...
	"AWS::SecurityHub::StandardsControl": {
		...
		GetDescriber:         nil,
		TerraformName:        "aws_securityhub_standards_control",
		TerraformServiceName: "securityhub",
	},
	...
	"AWS::Ram::PrincipalAssociation": {
		...
		GetDescriber:         nil,
		TerraformName:        "aws_ram_principal_association",
	...
	"AWS::Ram::ResourceAssociation": {
		...
		GetDescriber:         nil,
		TerraformName:        "aws_ram_resource_association",
		TerraformServiceName: "ram",
	},
	"AWS::RDS::ReservedDBInstance": {
		...
		GetDescriber:         nil,
		TerraformName:        "aws_rds_reserved_instance",
		TerraformServiceName: "rds",
	},
	"AWS::Redshift::SubnetGroup": {
		...
		GetDescriber:         nil,
		TerraformName:        "aws_redshift_subnet_group",
		TerraformServiceName: "redshift",
	},
