...
var AWSDescriptionMap = map[string]interface{}{
	...
	"AWS::Organizations::PolicyTarget":                   kaytu.OrganizationsPolicyTarget{},
	"AWS::Organizations::OrganizationalUnit":             kaytu.OrganizationsOrganizationalUnit{},
	"AWS::Organizations::Root":                           kaytu.OrganizationsRoot{},
	...
	"AWS::IAM::SSHPublicKey":                             kaytu.IAMSSHPublicKey{},
	...
	"AWS::Account::Account":                              kaytu.IAMAccount{},
	...
	"AWS::AccessAnalyzer::Finding":                       kaytu.AccessAnalyzerAnalyzerFinding{},
	...
	"AWS::KMS::KeyRotation":                              kaytu.KMSKeyRotation{},
	"AWS::EC2::Ipam":                                     kaytu.EC2Ipam{},
	"AWS::ElasticBeanstalk::Environment":                 kaytu.ElasticBeanstalkEnvironment{},
	"AWS::ElasticBeanstalk::ApplicationVersion":          kaytu.ElasticBeanstalkApplicationVersion{},
	...
	"AWS::Backup::RegionSetting":                         kaytu.BackupRegionSetting{},
	...
	"AWS::RDS::DBEngineVersion":                          kaytu.RDSDBEngineVersion{},
	...
	"AWS::WAF::RuleGroup":                                kaytu.WAFRuleGroup{},
	...
	"AWS::EC2::InstanceMetricCpuUtilizationHourly":       kaytu.EC2InstanceMetricCpuUtilizationHourly{},
	...
	"AWS::ECR::Registry":                                 kaytu.ECRRegistry{},
	"AWS::ECR::RegistryScanningConfiguration":            kaytu.ECRRegistryScanningConfiguration{},
	...
	"AWS::DocDB::ClusterSnapshot":                        kaytu.DocDBClusterSnapshot{},
	...
	"AWS::Neptune::DBClusterSnapshot":                    kaytu.NeptuneDatabaseClusterSnapshot{},
	...
	"AWS::RDS::DBRecommendation":                         kaytu.RDSDBRecommendation{},
	...
	"AWS::IAM::AccessAdvisor":                            kaytu.IAMAccessAdvisor{},
	...
	"AWS::DMS::Endpoint":                                 kaytu.DMSEndpoint{},
	"AWS::DMS::ReplicationTask":                          kaytu.DMSReplicationTask{},
	...
	"AWS::ServiceQuotas::Service":                        kaytu.ServiceQuotasService{},
	...
	"AWS::SSOAdmin::UserEffectiveAccess":                 kaytu.UserEffectiveAccess{},
	"AWS::SSOAdmin::Instance":                            kaytu.SSOAdminInstance{},
	"AWS::SSOAdmin::PermissionSet":                       kaytu.SSOAdminPermissionSet{},
	"AWS::SSOAdmin::AttachedManagedPolicy":               kaytu.SSOAdminPolicyAttachment{},
