...
build:
	...
	aws lambda update-function-code --function-name DescribeAWS --region us-east-2 --s3-bucket lambda-describe-binary --s3-key kaytu-aws-describer.zip --no-cli-pager --no-cli-auto-prompt
